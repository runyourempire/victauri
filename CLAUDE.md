...
- **`window introspectability`** (new action, same release) — probes every window's bridge and reports
  ...
  agent-friendly output). Shipped in **v0.7.3** (additive; stays in `^0.7` so `"0.7"` consumers like
